-- ==========================================
-- SUPABASE DATABASE SCHEMA FIXES - RUN THESE IN YOUR SUPABASE SQL EDITOR
-- ==========================================
...
INSERT INTO users (id, email, password_hash, business_name, business_type, is_active, created_at)
SELECT 'admin-bizpulse', 'bizpulse.erp@gmail.com', 'e5127f6e8926286647b57c61b944f17a15768d91438f714fe02939e1f0c1e061', 'BizPulse ERP', 'software', true, NOW()
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'bizpulse.erp@gmail.com');

-- Success message
SELECT '✅ ALL SCHEMA FIXES APPLIED SUCCESSFULLY!' as status;
SELECT '✅ Login should now work on deployed server' as message;
SELECT '✅ Remember to deploy your code changes as well' as reminder;